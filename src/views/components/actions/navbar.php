			...
			(new ElementBuilder())
				...
				->setContent(content:
					(new ElementBuilder)
						...
						->setContent(content: "<i class='ri-group-line'></i> " . $componentNavbarLang->translate(key: "NAVBAR_USERS"))
						->build()
				)
			...
			(new ElementBuilder())
				...
				->setContent(content:
					(new ElementBuilder)
						...
						->setContent(content: "<i class='ri-logout-box-line'></i> " . $componentNavbarLang->translate(key: "NAVBAR_DISCONNECT"))
						->build()
				)
